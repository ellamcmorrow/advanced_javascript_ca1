...
* Users can:<br/>
* Navigate around the site using an interactive hamburger menu.
...
* View a list of Projects on the ‘Projects’ page.
* View each individual project by clicking the ‘More info button’
* Navigate to the next project using the ‘View Project One/Two/All’ at the bottom of each individual project page.
* View a list of Github Repositories on the ‘Repositories’ page
* Search  by name by inputting text into search bar
* Filter by date created by clicking yes/no on radio button
<br/><br/>
External components include:<br />
