      ...
      <div>
        <div className="container">
          <section className="articles">
            <div className="column is-8 is-offset-2">
                ...
                <div className="card-content">
                  <div className="media">
                    ...
                    <div className="media-content has-text-centered">
                      <h1 className="title article-title">PROJECT TWO</h1>
                    </div>
                  </div>
                  <div class="content">
                    ...
                    <p>
                      ...
                      accumsan, metus ultrices eleifend gravida, nulla nunc
                      varius lectus, nec rutrum justo nibh eu lectus. Ut
                    ...
                    <dl>
                      <dt>Web</dt>
                      <dd>
                        The part of the Internet that contains websites and web
                        pages
                      </dd>
                      <dt>HTML</dt>
                    ...
                    <pre>
                      ...
                      consectetur adipiscing elit. Donec viverra nec nulla vitae
                      mollis.&lt;/p&gt; &lt;/body&gt; &lt;/html&gt;
                    </pre>
                    <p>
              ...
              <Link
                to="/projectThree"
                className="moreInfo navLinkStyles white"
                style={{ background: "#2d2d2d", color: "#EFEEED" }}
              >
                <b>VIEW PROJECT THREE</b>
              </Link>
            </div>
          </section>
        </div>
        ...
        >
          <div class="content has-text-centered">
            ...
            <a href="http://www.linkedin.com/ellamcmorrow">
              <i
